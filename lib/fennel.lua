...
package.preload["fennel.repl"] = package.preload["fennel.repl"] or function(...)
  local _714_ = require("fennel.utils")
  local utils = _714_
  local copy = _714_["copy"]
  ...
  local function default_on_error(errtype, err)
    local function _719_()
      local _718_0 = errtype
      if (_718_0 == "Runtime") then
  ...
  local function splice_save_locals(env, lua_source, scope)
    ...
    local function _728_()
      local _726_0, _727_0 = lua_source:match("^(.*)[\n ](return .*)$")
      if ((nil ~= _726_0) and (nil ~= _727_0)) then
        local body = _726_0
        local _return = _727_0
  ...
  local function completer(env, scope, text, _3ffulltext, _from, _to)
    ...
    local function add_partials(input, tbl, prefix)
      ...
      for k, is_mangled in utils.allpairs(_730_()) do
    ...
    do
      local _739_0 = tostring((_3ffulltext or text)):match("^%s*,([^%s()[%]]*)$")
      if (nil ~= _739_0) then
        local cmd_fragment = _739_0
  ...
  local function reload(module_name, env, on_values, on_error)
    local _743_0, _744_0 = pcall(specials["load-code"]("return require(...)", env), module_name)
    if ((_743_0 == true) and (nil ~= _744_0)) then
      ...
      local new = nil
      do
        local _745_0, _746_0 = pcall(require, module_name)
        if ((_745_0 == true) and (nil ~= _746_0)) then
          local new0 = _746_0
          new = new0
        elseif (true and (nil ~= _746_0)) then
          local _1 = _745_0
          local msg = _746_0
          on_error("Repl", msg)
      ...
      return on_values({"ok"})
    elseif ((_743_0 == false) and (nil ~= _744_0)) then
      local msg = _744_0
      ...
      elseif specials["macro-loaded"][module_name] then
        ...
        local function _751_()
          local _750_0 = msg:gsub("\n.*", "")
          return _750_0
        end
        return on_error("Runtime", _751_())
      end
    end
  end
  local function run_command(read, on_error, f)
    local _754_0, _755_0, _756_0 = pcall(read)
    if ((_754_0 == true) and (_755_0 == true) and (nil ~= _756_0)) then
      local val = _756_0
      local _757_0, _758_0 = pcall(f, val)
      if ((_757_0 == false) and (nil ~= _758_0)) then
        local msg = _758_0
        return on_error("Runtime", msg)
      end
    elseif (_754_0 == false) then
  ...
  local function apropos_2a(pattern, tbl, prefix, seen, names)
    for name, subtbl in pairs(tbl) do
      if (("string" == type(name)) and (package ~= subtbl)) then
        local _763_0 = type(subtbl)
        if (_763_0 == "function") then
          if ((prefix .. name)):match(pattern) then
            table.insert(names, (prefix .. name))
          end
        elseif (_763_0 == "table") then
          if not seen[subtbl] then
            ...
            apropos_2a(pattern, subtbl, (prefix .. name:gsub("%.", "/") .. "."), _765_, names)
          end
        end
      end
    end
  ...
  commands.apropos = function(_env, read, on_values, on_error, _scope)
    ...
    return run_command(read, on_error, _769_)
  end
    ...
    for _, path in ipairs(apropos(".*")) do
      ...
      do
        ...
        if ("function" == type(tgt)) then
          local _773_0 = (compiler.metadata):get(tgt, "fnl/docstring")
          if (nil ~= _773_0) then
            local docstr = _773_0
  ...
  commands["apropos-doc"] = function(_env, read, on_values, on_error, _scope)
    local function _777_(_241)
      return on_values(apropos_doc(tostring(_241)))
    end
    return run_command(read, on_error, _777_)
  end
  ...
  commands["apropos-show-docs"] = function(_env, read, on_values, on_error)
    local function _779_(_241)
      return apropos_show_docs(on_values, tostring(_241))
    end
    return run_command(read, on_error, _779_)
  end
  ...
  local function resolve(identifier, _780_0, scope)
    local _781_ = _780_0
    local env = _781_
    local ___replLocals___ = _781_["___replLocals___"]
    local e = nil
    local function _782_(_241, _242)
      return (___replLocals___[scope.unmanglings[_242]] or env[_242])
    end
    e = setmetatable({}, {__index = _782_})
    local function _783_(...)
      local _784_0, _785_0 = ...
      if ((_784_0 == true) and (nil ~= _785_0)) then
        local code = _785_0
        local function _786_(...)
          local _787_0, _788_0 = ...
          if ((_787_0 == true) and (nil ~= _788_0)) then
            local val = _788_0
            return val
          else
            local _ = _787_0
        ...
        return _786_(pcall(specials["load-code"](code, e)))
      else
        local _ = _784_0
        return nil
      end
    end
    return _783_(pcall(compiler["compile-string"], tostring(identifier), {scope = scope}))
  end
  commands.find = function(env, read, on_values, on_error, scope)
    local function _791_(_241)
      local _792_0 = nil
      do
        local _793_0 = utils["sym?"](_241)
        if (nil ~= _793_0) then
          local _794_0 = resolve(_793_0, env, scope)
          if (nil ~= _794_0) then
            _792_0 = debug.getinfo(_794_0)
          else
            _792_0 = _794_0
          end
        else
      ...
      local function _797_()
        local line = _792_0.linedefined
        local source = _792_0.source
        return (("string" == type(source)) and ("@" == source:sub(1, 1)))
      end
      if (((_G.type(_792_0) == "table") and (nil ~= _792_0.linedefined) and (nil ~= _792_0.source) and (_792_0.what == "Lua")) and _797_()) then
        local line = _792_0.linedefined
        local source = _792_0.source
        local fnlsrc = nil
        do
          local _798_0 = compiler.sourcemap
          if (nil ~= _798_0) then
            _798_0 = _798_0[source]
          end
          if (nil ~= _798_0) then
            _798_0 = _798_0[line]
          end
    ...
    return run_command(read, on_error, _791_)
  end
  ...
  commands.doc = function(env, read, on_values, on_error, scope)
    ...
    return run_command(read, on_error, _803_)
  end
  ...
  commands.compile = function(_, read, on_values, on_error, _0, _1, opts)
    local function _806_(_241)
      local _807_0, _808_0 = pcall(compiler.compile, _241, opts)
      if ((_807_0 == true) and (nil ~= _808_0)) then
        local result = _808_0
        return on_values({result})
      elseif (true and (nil ~= _808_0)) then
        local _2 = _807_0
        local msg = _808_0
  ...
  local function load_plugin_commands(plugins)
    for i = #(plugins or {}), 1, -1 do
      for name, f in pairs(plugins[i]) do
        local _810_0 = name:match("^repl%-command%-(.*)")
        if (nil ~= _810_0) then
          local cmd_name = _810_0
          commands[cmd_name] = f
        end
      end
    end
  ...
  local function run_command_loop(input, read, loop, env, on_values, on_error, scope, chars, opts)
    ...
    do
      local _812_0 = commands[command_name]
      if (nil ~= _812_0) then
        local command = _812_0
  ...
  local function try_readline_21(opts, ok, readline)
    if ok then
      ...
      opts.readChunk = function(parser_state)
        local _817_0 = readline.readline(prompt_for((0 == parser_state["stack-size"])))
        if (nil ~= _817_0) then
          local input = _817_0
          return (input .. "\n")
        end
  ...
  local function repl(_3foptions)
    ...
    local _821_ = copy(_3foptions)
    local opts = _821_
    local _3ffennelrc = _821_["fennelrc"]
    local _ = nil
    opts.fennelrc = nil
    _ = nil
    ...
    byte_stream, clear_stream = parser.granulate(_823_)
    local chars = {}
    local read, reset = nil, nil
    local function _824_(parser_state)
    ...
    read, reset = parser.parser(_824_)
    depth = (depth + 1)
    ...
    if opts.registerCompleter then
      local function _830_()
        local _829_0 = opts.scope
        local function _831_(...)
          return completer(env, _829_0, ...)
        end
        return _831_
      end
      opts.registerCompleter(_830_())
    end
      ...
      elseif command_3f(src_string) then
        ...
        if not_eof_3f then
          local function _835_(...)
            local _836_0, _837_0 = ...
            if ((_836_0 == true) and (nil ~= _837_0)) then
              local src = _837_0
              local function _838_(...)
                local _839_0, _840_0 = ...
                if ((_839_0 == true) and (nil ~= _840_0)) then
                  local chunk = _840_0
                  ...
                  return xpcall(_841_, _842_)
                elseif ((_839_0 == false) and (nil ~= _840_0)) then
                  local msg = _840_0
                  clear_stream()
              ...
              return _838_(_845_(...))
            elseif ((_836_0 == false) and (nil ~= _837_0)) then
              local msg = _837_0
              clear_stream()
              return callbacks.onError("Compile", msg)
            end
          end
          local function _847_()
            opts["source"] = src_string
            return opts
          end
          _835_(pcall(compiler.compile, form, _847_()))
  ...
  repl_mt.__call = function(_853_0, _3fopts)
    local _854_ = _853_0
    local overrides = _854_
    local view_opts = _854_["view-opts"]
    local opts = copy(_3fopts, copy(overrides))
    local _856_
    do
      local _855_0 = _3fopts
      if (nil ~= _855_0) then
        _855_0 = _855_0["view-opts"]
      end
      _856_ = _855_0
    end
    opts["view-opts"] = copy(_856_, copy(view_opts))
    return repl(opts)
  end
  return setmetatable({["view-opts"] = {}}, repl_mt)
end
package.preload["fennel.specials"] = package.preload["fennel.specials"] or function(...)
  local _488_ = require("fennel.utils")
  local utils = _488_
  local pack = _488_["pack"]
  local unpack = _488_["unpack"]
  local view = require("fennel.view")
  local parser = require("fennel.parser")
  local compiler = require("fennel.compiler")
  ...
  local function wrap_env(env)
    ...
    local function _491_(_, key, value)
      if utils["string?"](key) then
    ...
    local function _493_()
      ...
      do
        ...
        for k, v in utils.stablepairs(env) do
          ...
          if utils["string?"](k) then
            _495_ = compiler["global-unmangling"](k)
          else
            _495_ = k
          end
          k_15_, v_16_ = _495_, v
      ...
      return next, _494_, nil
    end
    return setmetatable({}, {__index = _489_, __newindex = _491_, __pairs = _493_})
  end
  ...
  local function current_global_names(_3fenv)
    local mt = nil
    do
      local _498_0 = getmetatable(_3fenv)
      if ((_G.type(_498_0) == "table") and (nil ~= _498_0.__pairs)) then
        local mtpairs = _498_0.__pairs
        local tbl_14_ = {}
  ...
  local function load_code(code, _3fenv, _3ffilename)
    ...
    local _503_0, _504_0 = rawget(_G, "setfenv"), rawget(_G, "loadstring")
    if ((nil ~= _503_0) and (nil ~= _504_0)) then
      local setfenv = _503_0
      local loadstring = _504_0
  ...
  local function doc_2a(tgt, name)
    ...
    if not tgt then
      ...
      local function _507_()
        local _506_0 = getmetatable(tgt)
        if ((_G.type(_506_0) == "table") and true) then
          local __call = _506_0.__call
          return ("function" == type(__call))
        end
      end
      if ((type(tgt) == "function") or _507_()) then
  ...
  local function compile_value(v)
    ...
    local chunk = {}
    local _517_ = compiler.compile1(v, scope, chunk, opts)
    local _518_ = _517_[1]
    local v0 = _518_[1]
    return v0
  end
  ...
  local function get_fn_name(ast, scope, fn_name, multi)
    if (fn_name and (fn_name[1] ~= "nil")) then
      local _524_
      if not multi then
        _524_ = compiler["declare-local"](fn_name, scope, ast)
      else
        _524_ = compiler["symbol-to-expression"](fn_name, scope)[1]
      end
      return _524_, not multi, 3
    else
      return nil, true, 2
    end
  end
  local function compile_named_fn(ast, f_scope, f_chunk, parent, index, fn_name, local_3f, arg_name_list, f_metadata)
    ...
    local _527_
    if local_3f then
      _527_ = "local function %s(%s)"
    else
      _527_ = "%s = function(%s)"
    end
    compiler.emit(parent, string.format(_527_, fn_name, table.concat(arg_name_list, ", ")), ast)
  ...
  local function get_function_metadata(ast, arg_list, index)
    local function _530_(_241, _242)
      local tbl_14_ = _241
    ...
    local function _532_(_241, _242)
      _241["fnl/docstring"] = _242
      return _241
    end
    return maybe_metadata(ast, utils["kv-table?"], _530_, maybe_metadata(ast, utils["string?"], _532_, {["fnl/arglist"] = arg_list}, index))
  end
  SPECIALS.fn = function(ast, scope, parent, opts)
    local f_scope = nil
    do
      local _533_0 = compiler["make-scope"](scope)
      _533_0["vararg"] = false
      f_scope = _533_0
    end
    local f_chunk = {}
  ...
  SPECIALS.lua = function(ast, _, parent)
    ...
    local _543_
    do
      local _542_0 = utils["sym?"](ast[3])
      if (nil ~= _542_0) then
        _543_ = tostring(_542_0)
      else
        _543_ = _542_0
      end
    end
  ...
  local function dot(ast, scope, parent)
    ...
    local _546_ = compiler.compile1(lhs_node, scope, parent, {nval = 1})
    local lhs = _546_[1]
    if (len == 2) then
      return tostring(lhs)
    else
      ...
      for i = 3, len do
        ...
        if (utils["string?"](index) and utils["valid-lua-identifier?"](index)) then
          ...
          local _547_ = compiler.compile1(index, scope, parent, {nval = 1})
          local index0 = _547_[1]
  ...
  SPECIALS.let = function(_554_0, scope, parent, opts)
    local _555_ = _554_0
    local _ = _555_[1]
    local bindings = _555_[2]
    local ast = _555_
  ...
  local function if_2a(ast, scope, parent, opts)
    ...
    if (#ast == 2) then
      ...
      for i = 2, (#ast - 1), 2 do
        local condchunk = {}
        local _564_ = compiler.compile1(ast[i], do_scope, condchunk, {nval = 1})
        local cond = _564_[1]
  ...
  local function remove_until_condition(bindings, ast)
    ...
    for i = (#bindings - 1), 3, -1 do
      local _570_0 = clause_3f(bindings[i])
      if ((_570_0 == false) or (_570_0 == nil)) then
      elseif (nil ~= _570_0) then
        local clause = _570_0
  ...
  local function compile_until(_3fcondition, scope, chunk)
    if _3fcondition then
      local _572_ = compiler.compile1(_3fcondition, scope, chunk, {nval = 1})
      local condition_lua = _572_[1]
  ...
  local function method_call(ast, scope, parent)
    ...
    local _583_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local target = _583_[1]
    local args = {}
    for i = 4, #ast do
      local subexprs = nil
      local _584_
      ...
      subexprs = compiler.compile1(ast[i], scope, parent, {nval = _584_})
      local tbl_17_ = args
      local i_18_ = #tbl_17_
    ...
    local _587_0 = method_special_type(ast)
    if (_587_0 == "native") then
      return native_method_call(ast, scope, parent, target, args)
    elseif (_587_0 == "nonnative") then
      return nonnative_method_call(ast, scope, parent, target, args)
    elseif (_587_0 == "binding") then
  ...
  SPECIALS.hashfn = function(ast, scope, parent)
    ...
    local f_scope = nil
    do
      local _594_0 = compiler["make-scope"](scope)
      _594_0["vararg"] = false
      _594_0["hashfn"] = true
      f_scope = _594_0
    end
  ...
  local function short_circuit_safe_3f(x, scope)
    ...
    elseif utils["list?"](x) then
      if utils["sym?"](x[1]) then
        local _600_0 = str1(x)
        if ((_600_0 == "fn") or (_600_0 == "hashfn") or (_600_0 == "let") or (_600_0 == "local") or (_600_0 == "var") or (_600_0 == "set") or (_600_0 == "tset") or (_600_0 == "if") or (_600_0 == "each") or (_600_0 == "for") or (_600_0 == "while") or (_600_0 == "do") or (_600_0 == "lua") or (_600_0 == "global")) then
          return false
        elseif (((_600_0 == "<") or (_600_0 == ">") or (_600_0 == "<=") or (_600_0 == ">=") or (_600_0 == "=") or (_600_0 == "not=") or (_600_0 == "~=")) and (comparator_special_type(x) == "binding")) then
          return false
        else
          local function _601_()
            return (1 ~= x[2])
          end
          if ((_600_0 == "pick-values") and _601_()) then
            return false
          else
  ...
  local function emit_short_circuit_if(ast, scope, parent, name, subast, accumulator, expr_string, setter)
    ...
    compiler.emit(parent, ("if %s then"):format(_612_()), subast)
    do
      local chunk = {}
  ...
  local function define_arithmetic_special(name, zero_arity, unary_prefix, _3flua_name)
    local _618_
    do
      local _617_0 = (_3flua_name or name)
      local function _619_(...)
        return operator_special(_617_0, zero_arity, unary_prefix, ...)
      end
      _618_ = _619_
    end
    SPECIALS[name] = _618_
  ...
  local function bitop_special(native_name, lib_name, zero_arity, unary_prefix, ast, scope, parent)
    if (#ast == 1) then
      ...
      for i = 2, len do
        ...
        subexprs = compiler.compile1(ast[i], scope, parent, {nval = _620_})
  ...
  local function native_comparator(op, _630_0, scope, parent)
    local _631_ = _630_0
    local _ = _631_[1]
    local lhs_ast = _631_[2]
    local rhs_ast = _631_[3]
    local _632_ = compiler.compile1(lhs_ast, scope, parent, {nval = 1})
    local lhs = _632_[1]
    local _633_ = compiler.compile1(rhs_ast, scope, parent, {nval = 1})
    local rhs = _633_[1]
  ...
  local function binding_comparator(op, chain_op, ast, scope, parent)
    ...
    return ("(" .. table.concat(_637_, chain) .. ")")
  end
  local function define_comparator_special(name, _3flua_op, _3fchain_op)
    do
      ...
      local function opfn(ast, scope, parent)
        ...
        local _639_0 = comparator_special_type(ast)
        if (_639_0 == "native") then
          return native_comparator(op, ast, scope, parent)
        elseif (_639_0 == "idempotent") then
          return idempotent_comparator(op, _3fchain_op, ast, scope, parent)
        elseif (_639_0 == "binding") then
  ...
  local function make_compiler_env(ast, scope, parent, _3fopts)
    local provided = nil
    do
      local _646_0 = (_3fopts or utils.root.options)
      if ((_G.type(_646_0) == "table") and (_646_0["compiler-env"] == "strict")) then
        provided = safe_compiler_env()
      elseif ((_G.type(_646_0) == "table") and (nil ~= _646_0.compilerEnv)) then
        local compilerEnv = _646_0.compilerEnv
        provided = compilerEnv
      elseif ((_G.type(_646_0) == "table") and (nil ~= _646_0["compiler-env"])) then
        local compiler_env = _646_0["compiler-env"]
    ...
    local function _649_(symbol)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.scopes.macro.manglings[tostring(symbol)]
    end
    local function _650_(base)
      return utils.sym(compiler.gensym((compiler.scopes.macro or scope), base))
    end
    local function _651_(form)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.macroexpand(form, compiler.scopes.macro)
    end
    env = {["assert-compile"] = compiler.assert, ["ast-source"] = utils["ast-source"], ["comment?"] = utils["comment?"], ["fennel-module-name"] = fennel_module_name, ["get-scope"] = _648_, ["in-scope?"] = _649_, ["list?"] = utils["list?"], ["macro-loaded"] = macro_loaded, ["multi-sym?"] = utils["multi-sym?"], ["sequence?"] = utils["sequence?"], ["sym?"] = utils["sym?"], ["table?"] = utils["table?"], ["varg?"] = utils["varg?"], _AST = ast, _CHUNK = parent, _IS_COMPILER = true, _SCOPE = scope, _SPECIALS = compiler.scopes.global.specials, _VARARG = utils.varg(), comment = utils.comment, gensym = _650_, list = utils.list, macroexpand = _651_, pack = pack, sequence = utils.sequence, sym = utils.sym, unpack = unpack, version = utils.version, view = view}
    env._G = env
  ...
  local _654_ = _652_(...)
  local dirsep = _654_[1]
  local pathsep = _654_[2]
  local pathmark = _654_[3]
  ...
  local function search_module(modulename, _3fpathstring)
    ...
    local function find_in_path(start, _3ftried_paths)
      local _657_0 = fullpath:match(pattern, start)
      if (nil ~= _657_0) then
        local path = _657_0
        local _658_0, _659_0 = try_path(path)
        if (nil ~= _658_0) then
          local filename = _658_0
          return filename
        elseif ((_658_0 == nil) and (nil ~= _659_0)) then
          local error = _659_0
          local function _661_()
            local _660_0 = (_3ftried_paths or {})
            table.insert(_660_0, error)
            return _660_0
          end
          return find_in_path((start + #path + 1), _661_())
        end
      else
        local _ = _657_0
  ...
  local function make_searcher(_3foptions)
    local function _666_(module_name)
      local opts = utils.copy(utils.root.options)
      for k, v in pairs((_3foptions or {})) do
        opts[k] = v
      end
      opts["module-name"] = module_name
      local _667_0, _668_0 = search_module(module_name)
      if (nil ~= _667_0) then
        local filename = _667_0
        local function _669_(...)
          return utils["fennel-module"].dofile(filename, opts, ...)
        end
        return _669_, filename
      elseif ((_667_0 == nil) and (nil ~= _668_0)) then
        local error = _668_0
        return error
      end
    end
  ...
  local function fennel_macro_searcher(module_name)
    local opts = nil
    do
      local _671_0 = utils.copy(utils.root.options)
      _671_0["module-name"] = module_name
      _671_0["env"] = "_COMPILER"
      _671_0["requireAsInclude"] = false
      _671_0["allowedGlobals"] = nil
      opts = _671_0
    end
    local _672_0 = search_module(module_name, utils["fennel-module"]["macro-path"])
    if (nil ~= _672_0) then
      local filename = _672_0
      local _673_
      ...
      return _673_, filename
    end
  end
  local function lua_macro_searcher(module_name)
    local _678_0 = search_module(module_name, package.path)
    if (nil ~= _678_0) then
      local filename = _678_0
      local code = nil
      do
        ...
        code = close_handlers_10_(_G.xpcall(_680_, (package.loaded.fennel or debug).traceback))
      end
  ...
  local function search_macro_module(modname, n)
    local _682_0 = macro_searchers[n]
    if (nil ~= _682_0) then
      local f = _682_0
      local _683_0, _684_0 = f(modname)
      if ((nil ~= _683_0) and true) then
        local loader = _683_0
        local _3ffilename = _684_0
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
      local function _687_(_, ...)
        return (compiler.metadata):setall(...)
      end
      return {metadata = {setall = _687_}, view = view}
    end
  end
  local function _689_(modname)
    ...
    return (macro_loaded[modname] or sandbox_fennel_module(modname) or _690_())
  end
  safe_require = _689_
  ...
  local function resolve_module_name(_691_0, _scope, _parent, opts)
    local _692_ = _691_0
    local second = _692_[2]
    local filename = _692_["filename"]
  ...
  local function include_path(ast, opts, path, mod, fennel_3f)
    ...
    do
      ...
      src = close_handlers_10_(_G.xpcall(_698_, (package.loaded.fennel or debug).traceback))
    end
  ...
  SPECIALS.include = function(ast, scope, parent, opts)
    ...
    local modexpr = nil
    do
      local _701_0, _702_0 = pcall(resolve_module_name, ast, scope, parent, opts)
      if ((_701_0 == true) and (nil ~= _702_0)) then
        local modname = _702_0
    ...
    if ((modexpr.type ~= "literal") or ((modexpr[1]):byte() ~= 34)) then
      ...
      local function _706_()
        local _705_0 = search_module(mod)
        if (nil ~= _705_0) then
          local fennel_path = _705_0
      ...
      res = ((utils["member?"](mod, (utils.root.options.skipInclude or {})) and opts.fallback(modexpr, true)) or include_circular_fallback(mod, modexpr, opts.fallback, ast) or utils.root.scope.includes[mod] or _706_())
  ...
  SPECIALS["pick-values"] = function(ast, scope, parent)
    ...
    if (1 == n) then
      local _710_ = compiler.compile1(vals, scope, parent, {nval = 1})
      local _711_ = _710_[1]
      local expr = _711_[1]
      return {("(" .. expr .. ")")}
    elseif (0 == n) then
...
package.preload["fennel.compiler"] = package.preload["fennel.compiler"] or function(...)
  local _282_ = require("fennel.utils")
  local utils = _282_
  local unpack = _282_["unpack"]
  local parser = require("fennel.parser")
  ...
  local function assert_compile(condition, msg, ast, _3ffallback_ast)
    if not condition then
      local _286_ = (utils.root.options or {})
      local error_pinpoint = _286_["error-pinpoint"]
      local source = _286_["source"]
      local unfriendly = _286_["unfriendly"]
      local ast0 = nil
  ...
  local function global_mangling(str)
    if utils["valid-lua-identifier?"](str) then
      ...
      local _293_
      do
        local _292_0 = utils.root.options
        if (nil ~= _292_0) then
          _292_0 = _292_0["global-mangle"]
        end
        _293_ = _292_0
      end
      if (_293_ == false) then
        ...
        local function _295_(_241)
          return string.format("_%02x", _241:byte())
        end
        return ("__fnl_global__" .. str:gsub("[^%w]", _295_))
      end
    end
  end
  local function global_unmangling(identifier)
    local _297_0 = string.match(identifier, "^__fnl_global__(.*)$")
    if (nil ~= _297_0) then
      local rest = _297_0
      local _298_0 = nil
      local function _299_(_241)
        return string.char(tonumber(_241:sub(2), 16))
      end
      _298_0 = rest:gsub("_[%da-f][%da-f]", _299_)
      return _298_0
    else
      local _ = _297_0
      return identifier
  ...
  local function global_allowed_3f(name)
    local allowed = nil
    do
      local _301_0 = utils.root.options
      if (nil ~= _301_0) then
        _301_0 = _301_0.allowedGlobals
      end
      allowed = _301_0
    end
  ...
  local function autogensym(base, scope)
    local _307_0 = utils["multi-sym?"](base)
    if (nil ~= _307_0) then
      local parts = _307_0
      ...
      return (scope.autogensyms[base] or _308_())
    end
  end
  ...
  local function declare_local(symbol, scope, ast, _3fvar_3f, _3fdeferred_scope_changes)
    ...
    mangling = string.gsub(string.gsub(raw, "-", "_"), "[^%w_]", _313_)
  ...
  local function symbol_to_expression(symbol, scope, _3freference_3f)
    ...
    local function _318_()
      local _317_0 = utils.root.options
      if (nil ~= _317_0) then
        _317_0 = _317_0.allowedGlobals
      end
      return _317_0
    end
    if (_318_() and not local_3f and scope.parent) then
  ...
  local function flatten_chunk(file_sourcemap, chunk, tab, depth)
    if chunk.leaf then
      local _328_ = utils["ast-source"](chunk.ast)
      local endline = _328_["endline"]
      local filename = _328_["filename"]
      local line = _328_["line"]
      ...
      do
        ...
        if (_330_0 == true) then
          tab0 = "  "
        elseif (_330_0 == false) then
          tab0 = ""
        elseif (nil ~= _330_0) then
          local tab1 = _330_0
          tab0 = tab1
        elseif (_330_0 == nil) then
          tab0 = ""
        else
        tab0 = nil
        end
  ...
  local function make_metadata()
    local function _340_(self, tgt, _3fkey)
      if self[tgt] then
        if (nil ~= _3fkey) then
    ...
    local function _343_(self, tgt, key, value)
      self[tgt] = (self[tgt] or {})
      self[tgt][key] = value
      return tgt
    end
    local function _344_(self, tgt, ...)
      local kv_len = select("#", ...)
      local kvs = {...}
      if ((kv_len % 2) ~= 0) then
    ...
    return setmetatable({}, {__index = {get = _340_, set = _343_, setall = _344_}, __mode = "k"})
  end
  ...
  local function handle_compile_opts(exprs, parent, opts, ast)
    ...
    if opts.target then
      ...
      emit(parent, string.format("%s = %s", opts.target, _354_()), ast)
    end
  ...
  local function find_macro(ast, scope)
    local macro_2a = nil
    do
      local _357_0 = utils["sym?"](ast[1])
      if (_357_0 ~= nil) then
        local _358_0 = tostring(_357_0)
        if (_358_0 ~= nil) then
          macro_2a = scope.macros[_358_0]
        else
          macro_2a = _358_0
        end
      else
  ...
  local function propagate_trace_info(_362_0, _index, node)
    local _363_ = _362_0
    local byteend = _363_["byteend"]
    local bytestart = _363_["bytestart"]
    local filename = _363_["filename"]
    local line = _363_["line"]
    do
  ...
  local function macroexpand_2a(ast, scope, _3fonce)
    ...
    if utils["list?"](ast) then
      _371_0 = find_macro(ast, scope)
    else
    _371_0 = nil
    end
    if (_371_0 == false) then
      return ast
    elseif (nil ~= _371_0) then
      local macro_2a = _371_0
  ...
  local function callable_3f(_381_0, ctype, callee)
    local _382_ = _381_0
    local call_ast = _382_[1]
  ...
  local function compile_function_call(ast, scope, parent, opts, compile1, len)
    local _384_ = compile1(ast[1], scope, parent, {nval = 1})[1]
    local callee = _384_[1]
    local ctype = _384_["type"]
    local fargs = {}
    ...
    for i = 2, len do
      ...
      subexprs = compile1(ast[i], scope, parent, {nval = _385_})
  ...
  local function compile_varg(ast, scope, parent, opts)
    ...
    if scope.hashfn then
      ...
      _390_ = "unexpected vararg"
    end
    assert_compile(scope.vararg, _390_, ast)
  ...
  do
    ...
    view_opts = {["negative-infinity"] = "(-1/0)", ["negative-nan"] = _393_, infinity = "(1/0)", nan = _395_}
  end
  local function compile_scalar(ast, _scope, parent, opts)
    local compiled = nil
    do
      local _397_0 = type(ast)
      if (_397_0 == "nil") then
        compiled = "nil"
      elseif (_397_0 == "boolean") then
        compiled = tostring(ast)
      elseif (_397_0 == "string") then
        compiled = serialize_string(ast)
      elseif (_397_0 == "number") then
  ...
  local function compile_table(ast, scope, parent, opts, compile1)
    local function escape_key(k)
      if ((type(k) == "string") and utils["valid-lua-identifier?"](k)) then
        ...
        local _399_ = compile1(k, scope, parent, {nval = 1})
        local compiled = _399_[1]
    ...
    do
      ...
      for k in utils.stablepairs(ast) do
        local val_19_ = nil
        if not keys[k] then
          local _402_ = compile1(ast[k], scope, parent, {nval = 1})
          local v = _402_[1]
  ...
  local function destructure(to, from, ast, scope, parent, opts)
    local opts0 = (opts or {})
    local _406_ = opts0
    local declaration = _406_["declaration"]
    local forceglobal = _406_["forceglobal"]
    local forceset = _406_["forceset"]
    local isvar = _406_["isvar"]
    local symtype = _406_["symtype"]
    ...
    local function getname(symbol, ast0)
      ...
      if declaration then
        ...
        if forceglobal then
          ...
          local _411_
          do
            local _410_0 = utils.root.options
            if (nil ~= _410_0) then
              _410_0 = _410_0.allowedGlobals
            end
            _411_ = _410_0
          end
          if _411_ then
            local _414_
            do
              local _413_0 = utils.root.options
              if (nil ~= _413_0) then
                _413_0 = _413_0.allowedGlobals
              end
              _414_ = _413_0
            end
            table.insert(_414_, raw)
          end
        end
    ...
    local function dynamic_set_target(_425_0)
      local _426_ = _425_0
      local _ = _426_[1]
      local target = _426_[2]
      local keys = {(table.unpack or unpack)(_426_, 3)}
    ...
    local function destructure_kv_rest(s, v, left, excluded_keys, destructure1)
      ...
      exclude_str = table.concat(_431_, ", ")
    ...
    local function destructure_rest(s, k, left, destructure1)
      ...
      assert_compile((utils["sequence?"](left) and _433_()), "expected rest argument before last parameter", left)
    ...
    local function optimize_table_destructure_3f(left, right)
      ...
      return (utils["sequence?"](left) and utils["sequence?"](right) and _434_())
    end
    local function destructure_table(left, rightexprs, top_3f, destructure1, up1)
      ...
      if optimize_table_destructure_3f(left, rightexprs) then
        ...
        do
          local _435_0 = nil
          if top_3f then
            _435_0 = exprs1(compile1(from, scope, parent))
          else
            _435_0 = exprs1(rightexprs)
          end
          if (_435_0 == "") then
            right = "nil"
          elseif (nil ~= _435_0) then
            local right0 = _435_0
            right = right0
          else
          right = nil
  ...
  local function compile_asts(asts, options)
    ...
    local _450_ = utils.root
    _450_["set-reset"](_450_)
  ...
  local function compile(from, _3fopts)
    local _453_0 = type(from)
    if (_453_0 == "userdata") then
      local function _454_()
        local _455_0 = from:read(1)
        if (nil ~= _455_0) then
          return _455_0:byte()
        else
          return _455_0
      ...
      return compile_stream(_454_, _3fopts)
    elseif (_453_0 == "function") then
  ...
  local function traceback_frame(info)
    ...
    elseif (info.what == "C") then
      ...
      if (info.what == "Lua") then
        ...
        return string.format("\9%s:%d: in function %s", info.short_src, info.currentline, _460_())
  ...
  local function traceback(_3fmsg, _3fstart)
    local _463_0 = type(_3fmsg)
    if ((_463_0 == "nil") or (_463_0 == "string")) then
      local msg = (_3fmsg or "")
      if ((msg:find("^%g+:%d+:%d+: Compile error:.*") or msg:find("^%g+:%d+:%d+: Parse error:.*")) and not utils["debug-on?"]("trace")) then
        return msg
      else
        local lines = {msg:gsub("^[^:]*:%d+:%s+", "runtime error: "), "stack traceback:"}
        local done_3f, level = false, (_3fstart or 2)
        while not done_3f do
          do
            local _464_0 = lua_getinfo(level, "Sln")
            if (_464_0 == nil) then
              done_3f = true
            elseif (nil ~= _464_0) then
              local info = _464_0
  ...
  local function do_quote(form, scope, parent, runtime_3f)
    ...
    elseif (type(form) == "table") then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s})", mixed_concat(quote_all(form), ", "), filename, _486_())
...
package.preload["fennel.friend"] = package.preload["fennel.friend"] or function(...)
  ...
  local function read_line(filename, line, _3fsource)
    if _3fsource then
      ...
      return close_handlers_10_(_G.xpcall(_198_, (package.loaded.fennel or debug).traceback))
    end
  end
  ...
  local function highlight_line(codeline, col, _3fendcol, opts)
    if ((opts and (false == opts["error-pinpoint"])) or (os and os.getenv and os.getenv("NO_COLOR"))) then
      ...
      local _201_ = (opts or {})
      local error_pinpoint = _201_["error-pinpoint"]
      ...
      local _203_ = (error_pinpoint or {"\27[7m", "\27[0m"})
      local open = _203_[1]
      local close = _203_[2]
      return (sub(codeline, 1, col) .. open .. sub(codeline, (col + 1), (endcol + 1)) .. close .. sub(codeline, (endcol + 2), eol))
    end
  end
  local function friendly_msg(msg, _205_0, source, opts)
    local _206_ = _205_0
    local col = _206_["col"]
    local endcol = _206_["endcol"]
    local endline = _206_["endline"]
    local filename = _206_["filename"]
    local line = _206_["line"]
  ...
  local function assert_compile(condition, msg, ast, source, opts)
    if not condition then
      local _210_ = utils["ast-source"](ast)
      local col = _210_["col"]
      local filename = _210_["filename"]
      local line = _210_["line"]
...
package.preload["fennel.parser"] = package.preload["fennel.parser"] or function(...)
  ...
  local function granulate(getchunk)
    ...
    local function _212_(parser_state)
      if not done_3f then
        if (index <= #c) then
          ...
          local _213_0 = getchunk(parser_state)
          if (nil ~= _213_0) then
            local input = _213_0
            c, index = input, 2
            return c:byte()
  ...
  local function parser_fn(getbyte, filename, _222_0)
    local _223_ = _222_0
    local options = _223_
    local comments = _223_["comments"]
    local source = _223_["source"]
    local unfriendly = _223_["unfriendly"]
    local stack = {}
    ...
    local function whitespace_3f(b)
      local function _231_()
        local _230_0 = options.whitespace
        if (nil ~= _230_0) then
          _230_0 = _230_0[b]
        end
        return _230_0
      end
      return ((b == 32) or ((9 <= b) and (b <= 13)) or _231_())
    end
    ...
    local function parse_stream()
      ...
      local function dispatch(v, _3fsource, _3fraw)
        ...
        local v0 = nil
        do
          local _235_0 = utils["hook-opts"]("parse-form", options, v, _3fsource, _3fraw, stack)
          if (nil ~= _235_0) then
            local hookv = _235_0
            v0 = hookv
          else
        ...
        local _237_0 = stack[#stack]
        if (_237_0 == nil) then
          retval, done_3f = v0, true
          return nil
        elseif ((_G.type(_237_0) == "table") and (nil ~= _237_0.prefix)) then
          local prefix = _237_0.prefix
          local source0 = nil
          do
            local _238_0 = table.remove(stack)
            set_source_fields(_238_0)
            source0 = _238_0
          end
          local list = utils.list(utils.sym(prefix, source0), v0)
          return dispatch(utils.copy(source0, list))
        elseif (nil ~= _237_0) then
          local top = _237_0
      ...
      local function badend()
        ...
        do
          local tbl_17_ = {}
          local i_18_ = #tbl_17_
          for _, _240_0 in ipairs(stack) do
            local _241_ = _240_0
            local closer = _241_["closer"]
        ...
        return parse_error(string.format("expected closing delimiter%s %s", _243_, string.char(unpack(closers))), 0)
      end
      ...
      local function parse_comment(b, contents)
        if (b and (10 ~= b)) then
          ...
          return parse_comment(getb(), _246_())
      ...
      local function add_comment_at(comments0, index, node)
        local _250_0 = comments0[index]
        if (nil ~= _250_0) then
          local existing = _250_0
      ...
      local function parse_string_loop(chars, b, state)
        ...
        local state0 = nil
        do
          local _261_0 = {state, b}
          if ((_G.type(_261_0) == "table") and (_261_0[1] == "base") and (_261_0[2] == 92)) then
            state0 = "backslash"
          elseif ((_G.type(_261_0) == "table") and (_261_0[1] == "base") and (_261_0[2] == 34)) then
            state0 = "done"
          elseif ((_G.type(_261_0) == "table") and (_261_0[1] == "backslash") and (_261_0[2] == 10)) then
      ...
      local function parse_string(source0)
        ...
        local _266_0 = (rawget(_G, "loadstring") or load)(("return " .. formatted))
        if (nil ~= _266_0) then
          local load_fn = _266_0
          return dispatch(load_fn(), source0, raw)
        elseif (_266_0 == nil) then
...
package.preload["fennel.utils"] = package.preload["fennel.utils"] or function(...)
  ...
  local function sym(str, _3fsource)
    ...
    return setmetatable(_148_, symbol_mt)
  end
  local function sequence(...)
    local function _151_(seq, view0, inspector, indent)
      local opts = nil
      do
    ...
    return setmetatable({...}, {__fennelview = _151_, sequence = sequence_marker})
  end
  local function expr(strcode, etype)
    return setmetatable({strcode, type = etype}, expr_mt)
  end
  local function comment_2a(contents, _3fsource)
    local _152_ = (_3fsource or {})
    local filename = _152_["filename"]
    local line = _152_["line"]
  ...
  local function varg(_3fsource)
    ...
    return setmetatable(_153_, varg_mt)
  end
  ...
  local function multi_sym_3f(str)
    ...
    elseif (type(str) ~= "string") then
      ...
      return ((str:match("%.") or str:match(":")) and not str:match("%.%.") and (str:byte() ~= string.byte(".")) and (str:byte() ~= string.byte(":")) and (str:byte(-1) ~= string.byte(".")) and (str:byte(-1) ~= string.byte(":")) and _159_())
    end
  end
  ...
  root = {chunk = nil, options = nil, reset = _164_, scope = nil}
  root["set-reset"] = function(_165_0)
    local _166_ = _165_0
    local chunk = _166_["chunk"]
    local options = _166_["options"]
    local reset = _166_["reset"]
    local scope = _166_["scope"]
    root.reset = function()
  ...
  local function lua_keyword_3f(str)
    local function _168_()
      local _167_0 = root.options
      if (nil ~= _167_0) then
        _167_0 = _167_0.keywords
      end
      if (nil ~= _167_0) then
        _167_0 = _167_0[str]
      end
    ...
    return (lua_keywords[str] or _168_())
  end
  ...
  local function warn(msg, _3fast, _3ffilename, _3fline)
    ...
    if (nil ~= _173_0) then
      ...
      if (_G.io and _G.io.stderr) then
        local loc = nil
        do
          local _176_0 = ast_source(_3fast)
          if ((_G.type(_176_0) == "table") and (nil ~= _176_0.filename) and (nil ~= _176_0.line)) then
            local filename = _176_0.filename
            local line = _176_0.line
            loc = (filename .. ":" .. line .. ": ")
          else
            local _0 = _176_0
  ...
  local warned = {}
  local function check_plugin_version(_181_0)
    local _182_ = _181_0
    local plugin = _182_
    local name = _182_["name"]
    local versions = _182_["versions"]
  ...
  local function hook_opts(event, _3foptions, ...)
    ...
    local function _185_(...)
      local _184_0 = _3foptions
      if (nil ~= _184_0) then
        _184_0 = _184_0.plugins
      end
      return _184_0
    end
    local function _188_(...)
      local _187_0 = root.options
      if (nil ~= _187_0) then
        _187_0 = _187_0.plugins
      end
      return _187_0
    end
...
local function eval(str, _3foptions, ...)
  ...
  loader = specials["load-code"](lua_source, env, _864_(...))
  opts.filename = nil
  return loader(...)
end
...
local function syntax()
  ...
  for k, v in pairs(_G) do
    local _865_0 = type(v)
    if (_865_0 == "function") then
      out[k] = {["function?"] = true, ["global?"] = true}
    elseif (_865_0 == "table") then
...
do
  ...
  local function with_open_2a(closable_bindings, ...)
    local bodyfn = setmetatable({filename="src/fennel/macros.fnl", line=105, bytestart=3410, sym('fn', nil, {quoted=true, filename="src/fennel/macros.fnl", line=105}), setmetatable({}, {filename="src/fennel/macros.fnl", line=105}), ...}, getmetatable(list()))
    local closer = setmetatable({filename="src/fennel/macros.fnl", line=107, bytestart=3457, sym('fn', nil, {quoted=true, filename="src/fennel/macros.fnl", line=107}), sym('close-handlers_12_', nil, {filename="src/fennel/macros.fnl", line=107}), setmetatable({sym('ok_13_', nil, {filename="src/fennel/macros.fnl", line=107}), _VARARG}, {filename="src/fennel/macros.fnl", line=107}), setmetatable({filename="src/fennel/macros.fnl", line=108, bytestart=3505, sym('if', nil, {quoted=true, filename="src/fennel/macros.fnl", line=108}), sym('ok_13_', nil, {filename="src/fennel/macros.fnl", line=108}), _VARARG, setmetatable({filename="src/fennel/macros.fnl", line=108, bytestart=3517, sym('error', nil, {quoted=true, filename="src/fennel/macros.fnl", line=108}), _VARARG, 0}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))
    local traceback = setmetatable({filename="src/fennel/macros.fnl", line=109, bytestart=3552, sym('.', nil, {quoted=true, filename="src/fennel/macros.fnl", line=109}), setmetatable({filename="src/fennel/macros.fnl", line=109, bytestart=3555, sym('or', nil, {quoted=true, filename="src/fennel/macros.fnl", line=109}), setmetatable({filename="src/fennel/macros.fnl", line=109, bytestart=3559, sym('?.', nil, {quoted=true, filename="src/fennel/macros.fnl", line=109}), sym('_G', nil, {quoted=true, filename="src/fennel/macros.fnl", line=109}), "package", "loaded", _G["fennel-module-name"]()}, getmetatable(list())), sym('_G.debug', nil, {quoted=true, filename="src/fennel/macros.fnl", line=110}), setmetatable({["traceback"]=setmetatable({filename=nil, line=nil, bytestart=nil, sym('hashfn', nil, {quoted=true, filename=nil, line=nil}), ""}, getmetatable(list()))}, {filename="src/fennel/macros.fnl", line=110})}, getmetatable(list())), "traceback"}, getmetatable(list()))
    for i = 1, #closable_bindings, 2 do
      assert(_G["sym?"](closable_bindings[i]), "with-open only allows symbols in bindings")
      table.insert(closer, 4, setmetatable({filename="src/fennel/macros.fnl", line=114, bytestart=3850, sym(':', nil, {quoted=true, filename="src/fennel/macros.fnl", line=114}), closable_bindings[i], "close"}, getmetatable(list())))
    end
    return setmetatable({filename="src/fennel/macros.fnl", line=115, bytestart=3893, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=115}), closable_bindings, closer, setmetatable({filename="src/fennel/macros.fnl", line=117, bytestart=3939, sym('close-handlers_12_', nil, {filename="src/fennel/macros.fnl", line=117}), setmetatable({filename="src/fennel/macros.fnl", line=117, bytestart=3956, sym('_G.xpcall', nil, {quoted=true, filename="src/fennel/macros.fnl", line=117}), bodyfn, traceback}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))
  end
  ...
  local function collect_2a(iter_tbl, key_expr, value_expr, ...)
    ...
    if (nil == value_expr) then
      ...
      kv_expr = setmetatable({filename="src/fennel/macros.fnl", line=154, bytestart=5593, sym('values', nil, {quoted=true, filename="src/fennel/macros.fnl", line=154}), key_expr, value_expr}, getmetatable(list()))
    end
    local into, intoless_iter = extract_into(iter_tbl, copy(iter_tbl))
    return setmetatable({filename="src/fennel/macros.fnl", line=156, bytestart=5700, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=156}), setmetatable({sym('tbl_16_', nil, {filename="src/fennel/macros.fnl", line=156}), (into or {})}, {filename="src/fennel/macros.fnl", line=156}), setmetatable({filename="src/fennel/macros.fnl", line=157, bytestart=5733, sym('each', nil, {quoted=true, filename="src/fennel/macros.fnl", line=157}), intoless_iter, setmetatable({filename="src/fennel/macros.fnl", line=158, bytestart=5763, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=158}), setmetatable({setmetatable({filename="src/fennel/macros.fnl", line=158, bytestart=5769, sym('k_17_', nil, {filename="src/fennel/macros.fnl", line=158}), sym('v_18_', nil, {filename="src/fennel/macros.fnl", line=158})}, getmetatable(list())), kv_expr}, {filename="src/fennel/macros.fnl", line=158}), setmetatable({filename="src/fennel/macros.fnl", line=159, bytestart=5798, sym('if', nil, {quoted=true, filename="src/fennel/macros.fnl", line=159}), setmetatable({filename="src/fennel/macros.fnl", line=159, bytestart=5802, sym('and', nil, {quoted=true, filename="src/fennel/macros.fnl", line=159}), setmetatable({filename="src/fennel/macros.fnl", line=159, bytestart=5807, sym('not=', nil, {quoted=true, filename="src/fennel/macros.fnl", line=159}), sym('k_17_', nil, {filename="src/fennel/macros.fnl", line=159}), sym('nil', nil, {quoted=true, filename="src/fennel/macros.fnl", line=159})}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=159, bytestart=5821, sym('not=', nil, {quoted=true, filename="src/fennel/macros.fnl", line=159}), sym('v_18_', nil, {filename="src/fennel/macros.fnl", line=159}), sym('nil', nil, {quoted=true, filename="src/fennel/macros.fnl", line=159})}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=160, bytestart=5849, sym('tset', nil, {quoted=true, filename="src/fennel/macros.fnl", line=160}), sym('tbl_16_', nil, {filename="src/fennel/macros.fnl", line=160}), sym('k_17_', nil, {filename="src/fennel/macros.fnl", line=160}), sym('v_18_', nil, {filename="src/fennel/macros.fnl", line=160})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), sym('tbl_16_', nil, {filename="src/fennel/macros.fnl", line=161})}, getmetatable(list()))
  end
  ...
  local function seq_collect(how, iter_tbl, value_expr, ...)
    ...
    local into, intoless_iter = extract_into(iter_tbl, copy(iter_tbl))
    if into then
      return setmetatable({filename="src/fennel/macros.fnl", line=173, bytestart=6383, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=173}), setmetatable({sym('tbl_19_', nil, {filename="src/fennel/macros.fnl", line=173}), into}, {filename="src/fennel/macros.fnl", line=173}), setmetatable({filename="src/fennel/macros.fnl", line=174, bytestart=6412, how, intoless_iter, setmetatable({filename="src/fennel/macros.fnl", line=174, bytestart=6433, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=174}), setmetatable({sym('val_20_', nil, {filename="src/fennel/macros.fnl", line=174}), value_expr}, {filename="src/fennel/macros.fnl", line=174}), setmetatable({filename="src/fennel/macros.fnl", line=175, bytestart=6491, sym('table.insert', nil, {quoted=true, filename="src/fennel/macros.fnl", line=175}), sym('tbl_19_', nil, {filename="src/fennel/macros.fnl", line=175}), sym('val_20_', nil, {filename="src/fennel/macros.fnl", line=175})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), sym('tbl_19_', nil, {filename="src/fennel/macros.fnl", line=176})}, getmetatable(list()))
    else
      return setmetatable({filename="src/fennel/macros.fnl", line=180, bytestart=6767, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=180}), setmetatable({sym('tbl_21_', nil, {filename="src/fennel/macros.fnl", line=180}), setmetatable({}, {filename="src/fennel/macros.fnl", line=180})}, {filename="src/fennel/macros.fnl", line=180}), setmetatable({filename="src/fennel/macros.fnl", line=181, bytestart=6793, sym('var', nil, {quoted=true, filename="src/fennel/macros.fnl", line=181}), sym('i_22_', nil, {filename="src/fennel/macros.fnl", line=181}), 0}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=182, bytestart=6815, how, iter_tbl, setmetatable({filename="src/fennel/macros.fnl", line=183, bytestart=6848, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=183}), setmetatable({sym('val_23_', nil, {filename="src/fennel/macros.fnl", line=183}), value_expr}, {filename="src/fennel/macros.fnl", line=183}), setmetatable({filename="src/fennel/macros.fnl", line=184, bytestart=6891, sym('when', nil, {quoted=true, filename="src/fennel/macros.fnl", line=184}), setmetatable({filename="src/fennel/macros.fnl", line=184, bytestart=6897, sym('not=', nil, {quoted=true, filename="src/fennel/macros.fnl", line=184}), sym('nil', nil, {quoted=true, filename="src/fennel/macros.fnl", line=184}), sym('val_23_', nil, {filename="src/fennel/macros.fnl", line=184})}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=185, bytestart=6934, sym('set', nil, {quoted=true, filename="src/fennel/macros.fnl", line=185}), sym('i_22_', nil, {filename="src/fennel/macros.fnl", line=185}), setmetatable({filename="src/fennel/macros.fnl", line=185, bytestart=6942, sym('+', nil, {quoted=true, filename="src/fennel/macros.fnl", line=185}), sym('i_22_', nil, {filename="src/fennel/macros.fnl", line=185}), 1}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=186, bytestart=6973, sym('tset', nil, {quoted=true, filename="src/fennel/macros.fnl", line=186}), sym('tbl_21_', nil, {filename="src/fennel/macros.fnl", line=186}), sym('i_22_', nil, {filename="src/fennel/macros.fnl", line=186}), sym('val_23_', nil, {filename="src/fennel/macros.fnl", line=186})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), sym('tbl_21_', nil, {filename="src/fennel/macros.fnl", line=187})}, getmetatable(list()))
    end
  end
  ...
  local function icollect_2a(iter_tbl, value_expr, ...)
    assert((_G["sequence?"](iter_tbl) and (2 <= #iter_tbl)), "expected iterator binding table")
    return seq_collect(sym('each', nil, {quoted=true, filename="src/fennel/macros.fnl", line=206}), iter_tbl, value_expr, ...)
  end
  ...
  local function fcollect_2a(iter_tbl, value_expr, ...)
    ...
    return seq_collect(sym('for', nil, {quoted=true, filename="src/fennel/macros.fnl", line=225}), iter_tbl, value_expr, ...)
  end
  ...
  local function accumulate_impl(for_3f, iter_tbl, body, ...)
    ...
    return setmetatable({filename="src/fennel/macros.fnl", line=235, bytestart=8848, sym('do', nil, {quoted=true, filename="src/fennel/macros.fnl", line=235}), setmetatable({filename="src/fennel/macros.fnl", line=236, bytestart=8859, sym('var', nil, {quoted=true, filename="src/fennel/macros.fnl", line=236}), accum_var, accum_init}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=237, bytestart=8895, iter, {unpack(iter_tbl, 3)}, setmetatable({filename="src/fennel/macros.fnl", line=238, bytestart=8939, sym('set', nil, {quoted=true, filename="src/fennel/macros.fnl", line=238}), accum_var, body}, getmetatable(list()))}, getmetatable(list())), _27_(...)}, getmetatable(list()))
  end
  ...
  local function partial_2a(f, ...)
    ...
    if (nil == bindings[1]) then
      return setmetatable({filename="src/fennel/macros.fnl", line=283, bytestart=10630, sym('fn', nil, {quoted=true, filename="src/fennel/macros.fnl", line=283}), setmetatable({_VARARG}, {filename="src/fennel/macros.fnl", line=283}), body}, getmetatable(list()))
    else
      return setmetatable({filename="src/fennel/macros.fnl", line=284, bytestart=10663, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=284}), bindings, setmetatable({filename="src/fennel/macros.fnl", line=285, bytestart=10691, sym('fn', nil, {quoted=true, filename="src/fennel/macros.fnl", line=285}), setmetatable({_VARARG}, {filename="src/fennel/macros.fnl", line=285}), body}, getmetatable(list()))}, getmetatable(list()))
    end
  end
  ...
  local function pick_args_2a(n, f)
    ...
    return setmetatable({filename="src/fennel/macros.fnl", line=294, bytestart=11030, sym('fn', nil, {quoted=true, filename="src/fennel/macros.fnl", line=294}), bindings, setmetatable({filename="src/fennel/macros.fnl", line=294, bytestart=11044, f, unpack(bindings)}, getmetatable(list()))}, getmetatable(list()))
  end
  ...
  local function lambda_2a(...)
    ...
    local function check_21(a)
      if _G["table?"](a) then
        ...
        if _33_ then
          return table.insert(args, check_position, setmetatable({filename="src/fennel/macros.fnl", line=315, bytestart=11979, sym('_G.assert', nil, {quoted=true, filename="src/fennel/macros.fnl", line=315}), setmetatable({filename="src/fennel/macros.fnl", line=315, bytestart=11990, sym('not=', nil, {quoted=true, filename="src/fennel/macros.fnl", line=315}), sym('nil', nil, {quoted=true, filename="src/fennel/macros.fnl", line=315}), a}, getmetatable(list())), ("Missing argument %s on %s:%s"):format(tostring(a), (a.filename or "unknown"), (a.line or "?"))}, getmetatable(list())))
        end
      end
    end
    ...
    return setmetatable({filename="src/fennel/macros.fnl", line=324, bytestart=12424, sym('fn', nil, {quoted=true, filename="src/fennel/macros.fnl", line=324}), unpack(args)}, getmetatable(list()))
  end
  ...
  local function macro_2a(name, ...)
    ...
    local args = {...}
    return setmetatable({filename="src/fennel/macros.fnl", line=330, bytestart=12576, sym('macros', nil, {quoted=true, filename="src/fennel/macros.fnl", line=330}), setmetatable({[tostring(name)]=setmetatable({filename="src/fennel/macros.fnl", line=330, bytestart=12602, sym('fn', nil, {quoted=true, filename="src/fennel/macros.fnl", line=330}), unpack(args)}, getmetatable(list()))}, {filename="src/fennel/macros.fnl", line=330})}, getmetatable(list()))
  end
  ...
  local function macrodebug_2a(form, return_3f)
    local handle = nil
    if return_3f then
      handle = sym('do', nil, {quoted=true, filename="src/fennel/macros.fnl", line=335})
    else
      handle = sym('print', nil, {quoted=true, filename="src/fennel/macros.fnl", line=335})
    end
    return setmetatable({filename="src/fennel/macros.fnl", line=338, bytestart=12998, handle, view(macroexpand(form, _SCOPE), {["detect-cycles?"] = false})}, getmetatable(list()))
  end
  ...
  local function import_macros_2a(binding1, module_name1, ...)
    ...
    for i = 1, select("#", binding1, module_name1, ...), 2 do
      ...
      local expr = setmetatable({filename="src/fennel/macros.fnl", line=357, bytestart=14159, sym('import-macros', nil, {quoted=true, filename="src/fennel/macros.fnl", line=357}), modname}, getmetatable(list()))
      local filename = nil
  ...
  local function assert_repl_2a(condition, ...)
    ...
    return setmetatable({filename="src/fennel/macros.fnl", line=382, bytestart=15378, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=382}), setmetatable({sym('unpack_44_', nil, {filename="src/fennel/macros.fnl", line=382}), setmetatable({filename="src/fennel/macros.fnl", line=382, bytestart=15392, sym('or', nil, {quoted=true, filename="src/fennel/macros.fnl", line=382}), sym('table.unpack', nil, {quoted=true, filename="src/fennel/macros.fnl", line=382}), sym('_G.unpack', nil, {quoted=true, filename="src/fennel/macros.fnl", line=382})}, getmetatable(list())), sym('pack_46_', nil, {filename="src/fennel/macros.fnl", line=383}), setmetatable({filename="src/fennel/macros.fnl", line=383, bytestart=15435, sym('or', nil, {quoted=true, filename="src/fennel/macros.fnl", line=383}), sym('table.pack', nil, {quoted=true, filename="src/fennel/macros.fnl", line=383}), setmetatable({filename=nil, line=nil, bytestart=nil, sym('hashfn', nil, {quoted=true, filename=nil, line=nil}), setmetatable({filename="src/fennel/macros.fnl", line=383, bytestart=15451, sym('doto', nil, {quoted=true, filename="src/fennel/macros.fnl", line=383}), setmetatable({sym('$...', nil, {quoted=true, filename="src/fennel/macros.fnl", line=383})}, {filename="src/fennel/macros.fnl", line=383}), setmetatable({filename="src/fennel/macros.fnl", line=383, bytestart=15464, sym('tset', nil, {quoted=true, filename="src/fennel/macros.fnl", line=383}), "n", setmetatable({filename="src/fennel/macros.fnl", line=383, bytestart=15473, sym('select', nil, {quoted=true, filename="src/fennel/macros.fnl", line=383}), "#", sym('$...', nil, {quoted=true, filename="src/fennel/macros.fnl", line=383})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), sym('vals_45_', nil, {filename="src/fennel/macros.fnl", line=386}), setmetatable({filename="src/fennel/macros.fnl", line=386, bytestart=15646, sym('pack_46_', nil, {filename="src/fennel/macros.fnl", line=386}), condition, ...}, getmetatable(list())), sym('condition_47_', nil, {filename="src/fennel/macros.fnl", line=387}), setmetatable({filename="src/fennel/macros.fnl", line=387, bytestart=15690, sym('.', nil, {quoted=true, filename="src/fennel/macros.fnl", line=387}), sym('vals_45_', nil, {filename="src/fennel/macros.fnl", line=387}), 1}, getmetatable(list())), sym('message_48_', nil, {filename="src/fennel/macros.fnl", line=388}), setmetatable({filename="src/fennel/macros.fnl", line=388, bytestart=15720, sym('or', nil, {quoted=true, filename="src/fennel/macros.fnl", line=388}), setmetatable({filename="src/fennel/macros.fnl", line=388, bytestart=15724, sym('.', nil, {quoted=true, filename="src/fennel/macros.fnl", line=388}), sym('vals_45_', nil, {filename="src/fennel/macros.fnl", line=388}), 2}, getmetatable(list())), "assertion failed, entering repl."}, getmetatable(list()))}, {filename="src/fennel/macros.fnl", line=382}), setmetatable({filename="src/fennel/macros.fnl", line=389, bytestart=15778, sym('if', nil, {quoted=true, filename="src/fennel/macros.fnl", line=389}), setmetatable({filename="src/fennel/macros.fnl", line=389, bytestart=15782, sym('not', nil, {quoted=true, filename="src/fennel/macros.fnl", line=389}), sym('condition_47_', nil, {filename="src/fennel/macros.fnl", line=389})}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=390, bytestart=15808, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=390}), setmetatable({sym('opts_49_', nil, {filename="src/fennel/macros.fnl", line=390}), setmetatable({["assert-repl?"]=true}, {filename="src/fennel/macros.fnl", line=390}), sym('fennel_50_', nil, {filename="src/fennel/macros.fnl", line=391}), setmetatable({filename="src/fennel/macros.fnl", line=391, bytestart=15864, sym('require', nil, {quoted=true, filename="src/fennel/macros.fnl", line=391}), _G["fennel-module-name"]()}, getmetatable(list())), sym('locals_51_', nil, {filename="src/fennel/macros.fnl", line=392}), add_locals(_G["get-scope"](), {})}, {filename="src/fennel/macros.fnl", line=390}), setmetatable({filename="src/fennel/macros.fnl", line=393, bytestart=15960, sym('set', nil, {quoted=true, filename="src/fennel/macros.fnl", line=393}), sym('opts_49_.message', nil, {filename="src/fennel/macros.fnl", line=393}), setmetatable({filename="src/fennel/macros.fnl", line=393, bytestart=15979, sym('fennel_50_.traceback', nil, {filename="src/fennel/macros.fnl", line=393}), sym('message_48_', nil, {filename="src/fennel/macros.fnl", line=393})}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=394, bytestart=16020, sym('each', nil, {quoted=true, filename="src/fennel/macros.fnl", line=394}), setmetatable({sym('k_52_', nil, {filename="src/fennel/macros.fnl", line=394}), sym('v_53_', nil, {filename="src/fennel/macros.fnl", line=394}), setmetatable({filename="src/fennel/macros.fnl", line=394, bytestart=16033, sym('pairs', nil, {quoted=true, filename="src/fennel/macros.fnl", line=394}), sym('_G', nil, {quoted=true, filename="src/fennel/macros.fnl", line=394})}, getmetatable(list()))}, {filename="src/fennel/macros.fnl", line=394}), setmetatable({filename="src/fennel/macros.fnl", line=395, bytestart=16058, sym('when', nil, {quoted=true, filename="src/fennel/macros.fnl", line=395}), setmetatable({filename="src/fennel/macros.fnl", line=395, bytestart=16064, sym('=', nil, {quoted=true, filename="src/fennel/macros.fnl", line=395}), sym('nil', nil, {quoted=true, filename="src/fennel/macros.fnl", line=395}), setmetatable({filename="src/fennel/macros.fnl", line=395, bytestart=16071, sym('.', nil, {quoted=true, filename="src/fennel/macros.fnl", line=395}), sym('locals_51_', nil, {filename="src/fennel/macros.fnl", line=395}), sym('k_52_', nil, {filename="src/fennel/macros.fnl", line=395})}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=395, bytestart=16087, sym('tset', nil, {quoted=true, filename="src/fennel/macros.fnl", line=395}), sym('locals_51_', nil, {filename="src/fennel/macros.fnl", line=395}), sym('k_52_', nil, {filename="src/fennel/macros.fnl", line=395}), sym('v_53_', nil, {filename="src/fennel/macros.fnl", line=395})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=396, bytestart=16121, sym('set', nil, {quoted=true, filename="src/fennel/macros.fnl", line=396}), sym('opts_49_.env', nil, {filename="src/fennel/macros.fnl", line=396}), sym('locals_51_', nil, {filename="src/fennel/macros.fnl", line=396})}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=397, bytestart=16156, sym('_G.assert', nil, {quoted=true, filename="src/fennel/macros.fnl", line=397}), setmetatable({filename="src/fennel/macros.fnl", line=397, bytestart=16167, sym('fennel_50_.repl', nil, {filename="src/fennel/macros.fnl", line=397}), sym('opts_49_', nil, {filename="src/fennel/macros.fnl", line=397})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=398, bytestart=16199, sym('values', nil, {quoted=true, filename="src/fennel/macros.fnl", line=398}), setmetatable({filename="src/fennel/macros.fnl", line=398, bytestart=16207, sym('unpack_44_', nil, {filename="src/fennel/macros.fnl", line=398}), sym('vals_45_', nil, {filename="src/fennel/macros.fnl", line=398}), 1, sym('vals_45_.n', nil, {filename="src/fennel/macros.fnl", line=398})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))
  end
  ...
  local function case_values(vals, pattern, unifications, case_pattern, opts)
    local condition = setmetatable({filename="src/fennel/match.fnl", line=20, bytestart=514, sym('and', nil, {quoted=true, filename="src/fennel/match.fnl", line=20})}, getmetatable(list()))
    local bindings = {}
  ...
  local function case_table(val, pattern, unifications, case_pattern, opts, _3ftop)
    ...
    if ("table" == _3ftop) then
      condition = setmetatable({filename="src/fennel/match.fnl", line=30, bytestart=991, sym('and', nil, {quoted=true, filename="src/fennel/match.fnl", line=30})}, getmetatable(list()))
    else
      condition = setmetatable({filename="src/fennel/match.fnl", line=30, bytestart=998, sym('and', nil, {quoted=true, filename="src/fennel/match.fnl", line=30}), setmetatable({filename="src/fennel/match.fnl", line=30, bytestart=1003, sym('=', nil, {quoted=true, filename="src/fennel/match.fnl", line=30}), setmetatable({filename="src/fennel/match.fnl", line=30, bytestart=1006, sym('_G.type', nil, {quoted=true, filename="src/fennel/match.fnl", line=30}), val}, getmetatable(list())), "table"}, getmetatable(list()))}, getmetatable(list()))
    end
    local bindings = {}
    for k, pat in pairs(pattern) do
      if _G["sym?"](pat, "&") then
        local rest_pat = pattern[(k + 1)]
        local rest_val = setmetatable({filename="src/fennel/match.fnl", line=35, bytestart=1181, sym('select', nil, {quoted=true, filename="src/fennel/match.fnl", line=35}), k, setmetatable({filename="src/fennel/match.fnl", line=35, bytestart=1192, setmetatable({filename="src/fennel/match.fnl", line=35, bytestart=1193, sym('or', nil, {quoted=true, filename="src/fennel/match.fnl", line=35}), sym('table.unpack', nil, {quoted=true, filename="src/fennel/match.fnl", line=35}), sym('_G.unpack', nil, {quoted=true, filename="src/fennel/match.fnl", line=35})}, getmetatable(list())), val}, getmetatable(list()))}, getmetatable(list()))
        local subcondition = case_table(setmetatable({filename="src/fennel/match.fnl", line=36, bytestart=1270, sym('pick-values', nil, {quoted=true, filename="src/fennel/match.fnl", line=36}), 1, rest_val}, getmetatable(list())), rest_pat, unifications, case_pattern, without(opts, "multival?"))
      ...
      elseif (("number" ~= type(k)) or (not _G["sym?"](pattern[(k - 1)], "&as") and not _G["sym?"](pattern[(k - 1)], "&"))) then
        local subval = setmetatable({filename="src/fennel/match.fnl", line=58, bytestart=2404, sym('.', nil, {quoted=true, filename="src/fennel/match.fnl", line=58}), val, k}, getmetatable(list()))
  ...
  local function case_guard(vals, condition, guards, unifications, case_pattern, opts)
    if guards[1] then
      ...
      local condition0 = setmetatable({filename="src/fennel/match.fnl", line=69, bytestart=2988, sym('and', nil, {quoted=true, filename="src/fennel/match.fnl", line=69}), unpack(guards)}, getmetatable(list()))
      return setmetatable({filename="src/fennel/match.fnl", line=70, bytestart=3028, sym('and', nil, {quoted=true, filename="src/fennel/match.fnl", line=70}), pcondition, setmetatable({filename="src/fennel/match.fnl", line=71, bytestart=3066, sym('let', nil, {quoted=true, filename="src/fennel/match.fnl", line=71}), bindings, condition0}, getmetatable(list()))}, getmetatable(list())), bindings
    else
  ...
  local function case_or(vals, pattern, guards, unifications, case_pattern, opts)
    ...
    if (nil == bindings[1]) then
      local condition = nil
      do
        local tbl_17_ = setmetatable({filename="src/fennel/match.fnl", line=125, bytestart=5340, sym('or', nil, {quoted=true, filename="src/fennel/match.fnl", line=125})}, getmetatable(list()))
        local i_18_ = #tbl_17_
      ...
      local _20_
      if guards[1] then
        _20_ = setmetatable({filename="src/fennel/match.fnl", line=128, bytestart=5481, sym('and', nil, {quoted=true, filename="src/fennel/match.fnl", line=128}), condition, unpack(guards)}, getmetatable(list()))
      else
        _20_ = condition
      end
      return _20_, {}
      ...
      local pre_bindings = setmetatable({filename="src/fennel/match.fnl", line=135, bytestart=5856, sym('if', nil, {quoted=true, filename="src/fennel/match.fnl", line=135})}, getmetatable(list()))
      for _, subpattern in ipairs(pattern0) do
        local subcondition, subbindings = case_guard(vals, subpattern, guards, {}, case_pattern, opts)
        table.insert(pre_bindings, subcondition)
        table.insert(pre_bindings, setmetatable({filename="src/fennel/match.fnl", line=139, bytestart=6102, sym('let', nil, {quoted=true, filename="src/fennel/match.fnl", line=139}), subbindings, setmetatable({filename="src/fennel/match.fnl", line=140, bytestart=6162, sym('values', nil, {quoted=true, filename="src/fennel/match.fnl", line=140}), true, unpack(bindings)}, getmetatable(list()))}, getmetatable(list())))
      end
      return matched_3f, {setmetatable({filename="src/fennel/match.fnl", line=142, bytestart=6242, unpack(bindings)}, getmetatable(list())), setmetatable({filename="src/fennel/match.fnl", line=142, bytestart=6264, sym('values', nil, {quoted=true, filename="src/fennel/match.fnl", line=142}), unpack(bindings_mangled)}, getmetatable(list()))}, {setmetatable({filename="src/fennel/match.fnl", line=143, bytestart=6319, matched_3f, unpack(bindings_mangled)}, getmetatable(list())), pre_bindings}
    end
  end
  ...
  local function case_pattern(vals, pattern, unifications, opts, _3ftop)
    ...
    if (_G["sym?"](pattern) and (_G["sym?"](pattern, "nil") or (opts["infer-unification?"] and _G["in-scope?"](pattern) and not _G["sym?"](pattern, "_")) or (opts["infer-unification?"] and _G["multi-sym?"](pattern) and _G["in-scope?"](_G["multi-sym?"](pattern)[1])))) then
      return setmetatable({filename="src/fennel/match.fnl", line=177, bytestart=8240, sym('=', nil, {quoted=true, filename="src/fennel/match.fnl", line=177}), val, pattern}, getmetatable(list())), {}
    elseif (_G["sym?"](pattern) and unifications[tostring(pattern)]) then
      return setmetatable({filename="src/fennel/match.fnl", line=180, bytestart=8388, sym('=', nil, {quoted=true, filename="src/fennel/match.fnl", line=180}), unifications[tostring(pattern)], val}, getmetatable(list())), {}
    elseif _G["sym?"](pattern) then
      ...
      if (wildcard_3f or string.find(tostring(pattern), "^?")) then
        ...
        _26_ = setmetatable({filename="src/fennel/match.fnl", line=186, bytestart=8727, sym('not=', nil, {quoted=true, filename="src/fennel/match.fnl", line=186}), sym("nil"), val}, getmetatable(list()))
      end
    ...
    elseif (_G["list?"](pattern) and _G["sym?"](pattern[1], "=") and _G["sym?"](pattern[2])) then
      ...
      return setmetatable({filename="src/fennel/match.fnl", line=196, bytestart=9341, sym('=', nil, {quoted=true, filename="src/fennel/match.fnl", line=196}), val, bind}, getmetatable(list())), {}
    ...
    elseif (type(pattern) == "table") then
      ...
      return setmetatable({filename="src/fennel/match.fnl", line=228, bytestart=11078, sym('=', nil, {quoted=true, filename="src/fennel/match.fnl", line=228}), val, pattern}, getmetatable(list())), {}
    end
  end
  ...
  local function add_pre_bindings(out, pre_bindings)
    if pre_bindings then
      local tail = setmetatable({filename="src/fennel/match.fnl", line=237, bytestart=11476, sym('if', nil, {quoted=true, filename="src/fennel/match.fnl", line=237})}, getmetatable(list()))
      table.insert(out, true)
      table.insert(out, setmetatable({filename="src/fennel/match.fnl", line=239, bytestart=11541, sym('let', nil, {quoted=true, filename="src/fennel/match.fnl", line=239}), pre_bindings, tail}, getmetatable(list())))
      return tail
    else
      return out
    end
  ...
  local function case_condition(vals, clauses, match_3f, top_table_3f)
    local root = setmetatable({filename="src/fennel/match.fnl", line=248, bytestart=11882, sym('if', nil, {quoted=true, filename="src/fennel/match.fnl", line=248})}, getmetatable(list()))
    do
      local out = root
      for i = 1, #clauses, 2 do
        ...
        table.insert(out0, setmetatable({filename="src/fennel/match.fnl", line=261, bytestart=12619, sym('let', nil, {quoted=true, filename="src/fennel/match.fnl", line=261}), bindings, body}, getmetatable(list())))
        out = out0
      end
    end
    return root
  ...
  local function maybe_optimize_table(val, clauses)
    ...
    if _33_ then
      ...
      return setmetatable({filename="src/fennel/match.fnl", line=293, bytestart=13902, sym('values', nil, {quoted=true, filename="src/fennel/match.fnl", line=293}), unpack(val)}, getmetatable(list())), _35_()
    else
      return val, clauses
    end
  end
  ...
  local function case_try_step(how, expr, _else, pattern, body, ...)
    if ((nil == pattern) and (pattern == body)) then
      ...
      return setmetatable({filename="src/fennel/match.fnl", line=346, bytestart=15853, setmetatable({filename="src/fennel/match.fnl", line=346, bytestart=15854, sym('fn', nil, {quoted=true, filename="src/fennel/match.fnl", line=346}), setmetatable({_VARARG}, {filename="src/fennel/match.fnl", line=346}), setmetatable({filename="src/fennel/match.fnl", line=347, bytestart=15874, how, _VARARG, pattern, case_try_step(how, body, _else, ...), unpack(_else)}, getmetatable(list()))}, getmetatable(list())), expr}, getmetatable(list()))
    end
  end
  ...
  local function case_try_impl(how, expr, pattern, body, ...)
    ...
    if _G["sym?"]((("table" == type(last)) and last[1]), "catch") then
      ...
      catch = {sym('__43_', nil, {filename="src/fennel/match.fnl", line=357}), _VARARG}
    end
